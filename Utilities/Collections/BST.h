    ...
    namespace Utilities
    {
        ...
        class BST : public ICollection<U>
        {
            public:
                ...
                /** OPERATORS **/
                Iterator begin()                            const { return Iterator(0, Root); }
                ...
                virtual const U& operator ()(uint index)    const { return (const U&)(Root->Index(index)->Value); }
            ...
            private:
                ...
                struct Iterator
                {
                    public:
                        ...
                        /** OPERATORS **/
                        Node<T, U>& operator *()                { return *(Root->Index(_index)); }

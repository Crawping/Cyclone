...
/* CALLBACK - An abstract interface meant for use in event callback functions. */
template<typename ... T>
struct Callback
{   
...
/* PLAINFUNCTIONPOINTER - A structure representing an ordinary function pointer that takes a single argument. */
template<typename ... T>
struct PlainFunctionPointer : public Callback<T...>
{
    private:
        typedef void (*FunctionPointer)(T ... arguments);
        /* FUNCTION - A pointer to the function that can be invoked through this class. */
...
/* OBJECTMETHODPOINTER - A structure representing a pointer to an object method. */
template<typename T, typename ... U>
struct ObjectMethodPointer : public Callback<U...>
{
    private:
        using MethodPointer = void (T::*)(U ... arguments);
        /* OBJECT - A pointer to the object instance needed to succesfully call a class method. */
        T* Object;
        /* METHOD - A pointer to the method function that will eventually be called. */

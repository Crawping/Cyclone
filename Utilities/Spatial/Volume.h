...
/* VOLUME - A data structure that describes a three-dimensional rectangular prism occupying a volume of space. */
struct UtilitiesAPI Volume
{

    /** CONSTANT DATA **/
    /* EMPTY - A rectangular prism whose position and size are all equal to zero. */
    const static Volume Empty;
    /* UNIT - A rectangular prism with unit volume positioned at the origin (0, 0, 0). */
    const static Volume Unit;



    /** DATA **/
    /* X - The x-axis coordinate for the front-lower-left corner of the rectangular prism. */
    float X;
    /* Y - The y-axis coordinate for the front-lower-left corner of the rectangular prism. */
    float Y;
    /* Z - The z-axis coordinate for the front-lower-left corner of the rectangular prism. */
    float Z;

    /* WIDTH - The extent of the volume along the x-axis. */
    float Width;
    /* HEIGHT - The extent of the volume along the y-axis. */
    float Height;
    /* DEPTH - The extent of the volume along the z-axis. */
    float Depth;

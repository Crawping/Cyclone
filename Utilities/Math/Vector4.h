...
namespace Cyclone
{
    namespace Utilities
    {
        struct UtilitiesAPI Vector4
        {
            ...
            /** CONSTRUCTORS **/
            /// <summary> Constructs a 4-element vector pointing to the origin (0, 0, 0, 0). </summary>
            constexpr Vector4()                                                     : X(0), Y(0), Z(0), W(0) { }
            /// <summary> Constructs a 4-element vector pointing to uniform coordinates. </summary>
            ...
            /// <summary> Constructs a 4-element vector by appending a w-coordinate to a 3-element vector. </summary>
            /// <param name="v"> An existing 3-element vector of values. </param>
            /// <param name="w">
            ///     The w-coordinate to be appended to the inputted vector <paramref name="v"/>.
            ///     DEFAULT: 0.0f
            /// </param>
            constexpr Vector4(const Vector3& v, float w = 0.0f)                     : X(v.X), Y(v.Y), Z(v.Z), W(w) { }
            /// <summary> Constructs a 4-element vector by appending a z- and w-coordinate to a 2-element vector. </summary>
            ...
            /// <summary> Constructs a 4-element vector pointing to the specified coordinates. </summary>
            ...
            /** OPERATORS **/
            /// <summary> Converts the object from a 4-element vector into a 2-element one by ignoring the (z, w) coordinates. </summary>
            /// <returns> A new 2-element vector containing the (x, y) coordinates from the original 4-element one. </returns>
            constexpr explicit operator Vector2()                   const { return Vector2(X, Y); }
            /// <summary> Converts the object from a 4-element vector into a 3-element one by ignoring the w-coordinate. </summary>
            /// <returns> A new 2-element vector containing the (x, y, z) coordinates from the original 4-element one. </returns>

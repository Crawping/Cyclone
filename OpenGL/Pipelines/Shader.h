...
class Shader
{
    public:
        ...
        /* SHADER - Constructs a new shader program that can be plugged into the programmable GPU rendering stages.
         *
         * SYNTAX:
         *      S = Shader(fileName, type)
         *
         * OUTPUT:
         *      S:          Shader
         *
         * INPUTS:
         *      fileName:   string
         *                  A string containing the name or path of the shader program source code file to be compiled.
         *
         *      type:       ShaderTypes

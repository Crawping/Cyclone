...
/** PRIVATE UTILITIES **/
/* COMPILE - Compiles the GLSL source code for this shader into a binary package.
 *
 *      Compiled shader programs can be linked together to form a shader program pipeline.
 */
...
/* PREPROCESS - Edits the GLSL source code as necessary before passing it on to the shader program compiler.
 *
...
/* POSTSHADERLOG - Retrieves and posts error information that was logged while attempting to compile this shader program. */
